...
<br><br>
`@bot version` or `@bot ver` or `@bot changlog` or `@bot log`: If in posts and not chat, it will output the current running version and the FULL CHANGELOG. If it's in chat, it will output the current running version and the description of the last change.
<br><br>
...
<br><br>
**DELETING ERROR PREVENTION:** It prevents an error from happening when you ping the bot then you delete your messasge before bot can respond.
<br><br>
...
<br>
Assistance and help: ChatGPT, DeepSeek, Gemini, [ethandacat](https://github.com/ethandacat), and @XC230506 (xkcd-reader) from X-Camp Discourse.
<br><br>
